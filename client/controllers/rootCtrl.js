...
rootCtrl.controller('rootCtrl', ['$scope', '$http', '$rootScope', '$route', '$location', '$interval', '$timeout', 'routes', 'ngDialog', 'authService',
    function ($scope, $http, $rootScope, $route, $location, $interval, $timeout, routes, ngDialog, authService) {
